...
import RoadMapDesk from '../../assets/Images/RoadMapDesk.png'
import './roadmapdesktop.scss';

export default function Roadmapdesktop() {
    return (
        <div className="roadmapdesktop">
            <img className='roadmapdesktop-img' src={RoadMapDesk} alt="roadmapdesktop img" />
            <div className="roadmapdesktop-container">
